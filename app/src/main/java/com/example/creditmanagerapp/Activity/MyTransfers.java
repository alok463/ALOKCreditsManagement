...
import com.example.creditmanagerapp.Data.DatabaseHandler;
import com.example.creditmanagerapp.Model.Transfer;
import com.example.creditmanagerapp.Model.User;
...
public class MyTransfers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transferButton = findViewById(R.id.transfer_activity_buttons);
        creditTransfer = findViewById(R.id.transferCreditss);
                ...
                public void onClick(View view) {
                    ...
                    if(!creditTransfer.getText().toString().isEmpty()) {
                        ...
                        if(credits <= 0 || credits > currUser.getCurrCredit()) {
                            Toast.makeText(MyTransfers.this, "Invalid Credit Amount", Toast.LENGTH_LONG).show();
                        }
                            ...
                            startActivity(new Intent(MyTransfers.this, AllUser.class));
                            finish();
                        }
                    }
                }
